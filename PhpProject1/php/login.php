...
// comprobar si el usuario ya ha iniciado sesión, si es así, redirigirlo a la página de bienvenida
                ...
                if (mysqli_stmt_num_rows($stmt) == 1) {
                    ...
                    if (mysqli_stmt_fetch($stmt)) {
                        if (password_verify($password, $hashed_password)) {
                            // La contraseña es correcta, así que inicia una nueva sesion
                            session_start();

                            // Datos almacenados en variables de sesion
                    ...
                    // muestra un mensaje de error si no existe el usuario
