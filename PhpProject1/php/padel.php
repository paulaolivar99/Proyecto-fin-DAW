                ...
                <div class="row border-2 shadow-lg p-3 mb-3 bg-white ">
                    ...
                    <div class="col-sm-12 my-2">
                        <div class="row my-3">
                            ...
                            <div class="col-sm-9">    
                                <form action="../php/padel2.php" method="post">

                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="nombre">Nombre al que se hace la reserva</label>
                                            <input type="text" class="form-control" id="nombre" name="nombre" required value="" placeholder="Escribe tu nombre" />
                                        </div>
                                    </div> <!--pedir nombre-->
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group my-2">
                                            ...
                                            <input type="tel" class="form-control" id="telefono" name="telefono" required pattern="^[9|8|7|6]\d{8}$" value="" placeholder="Escribe tu teléfono" />
                                        </div>
                                    </div> <!--pedir telefono-->
                                    ...
                                    <input type="hidden" name="tipo" value="<?php echo "padel"; ?>">
