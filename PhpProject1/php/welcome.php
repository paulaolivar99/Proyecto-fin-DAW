        ...
        <div class="row">
            ...
            <main>
                <div class="row border-2 shadow-lg p-3 mb-3 bg-white ">
                    ...
                    <!--frase bienvenida-->
                    <div class="col-sm-10 " id="morecsspure">
                        <h5 class="my-3">Hola, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. </h5>

                        <h1> Bienvenid@ al sitio web de reservas. </h1> 
                    </div>


                    <div class="row border-2 p-3 mb-3 bg-white text-center ">
                        <h3> ¿Qué quieres reservar? </h3>
                        <div class="col-sm-12 my-2">
                            <div class="row my-3">
                                <div class="col-sm-4 ">
                                    <a class="btn btn-info btn-lg my-3" href="padel.php" role="button">Pista pádel</a>  
                                    <img src="../imgs/padel.jpg" width="90%"  />
                                </div>

                                <div class="col-sm-4">
                                    <a class="btn btn-info btn-lg  my-3" href="salon.php" role="button">Salón</a>  
                                    <img src="../imgs/salon.JPG" width="86%"  />
                                </div>

                                <div class="col-sm-4">
                                    <a class="btn btn-info btn-lg my-3" href="merendero.php" role="button">Merendero</a>  

                                    <img src="../imgs/merendero.jpg" width="82%"  />
                                </div>
                            </div>
                        </div>
                    </div>
