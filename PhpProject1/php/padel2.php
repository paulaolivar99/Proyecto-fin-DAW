...
<?php
$fecha = $_POST['fecha'];
$obtenerHoras = "SELECT * FROM reservas where tipo = 'padel' and fecha =  '$fecha' ;";
$horasDisponibles = ['7:00', '8:00', '9:00', '10:00', '11:00', '12:00', '13:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00', '22:00', '23:00'];


if (mysqli_query($link, $obtenerHoras)) {
    $horas = mysqli_query($link, $obtenerHoras);
} else {
    echo "Error: " . $obtenerHoras . "<br>" . mysqli_error($link);
}
            ...
            <main>
                <div class="row border-2 shadow-lg p-3 mb-3 bg-white ">
                    ...
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <strong>¡Atención!</strong> La pista de pádel solo se puede reservar de hora en hora. Para ello, se elige un día disponible del calendario y se selecciona la hora.
                    ...
                    <h3 class="text-center my-2">Reservar Pista de Pádel</h3>
                    <div class="col-sm-12 my-2">
                        <div class="row my-3">
                            <div class="col-sm-3 ">
                                <a class="btn btn-info btn-lg my-3 disabled" href="pista.php" role="button">Pista pádel</a>  
                                <img src="../imgs/padel.jpg" width="90%"  />
                            </div>
                            <div class="col-sm-9">    
                                        ...
                                        <div class="form-group my-2">
                                            ...
                                            <form action='../php/agregarReserva.php' method="post">
                                                <?php foreach ($horasBotones as $h) { ?>
                                                    ...
                                                    <input type='submit' name='hora' value='<?php echo $h ?>'>
                                                <?php } ?>
                                            </form
                                        </div>
                                    </div> <!--pedir hora-->
