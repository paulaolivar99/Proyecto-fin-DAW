...
<?php
$reservasMerendero = "SELECT * FROM reservas where tipo = 'merendero' group by fecha";


if (mysqli_query($link, $reservasMerendero)) {
    $merendero = mysqli_query($link, $reservasMerendero);
} else {
    echo "Error: " . $reservasMerendero . "<br>" . mysqli_error($link);
}

$fechasOcupadas = [];
foreach ($merendero as $row) {
    $fechasOcupadas[] .= $row['fecha'];
}

//$horasBotones = array_diff($horasDisponibles, $horasOcupadas);
$fechas = "SELECT DAY(fecha) as 'dia' FROM reservas where tipo = 'merendero' group by fecha";
            ...
            <main>
                <div class="row border-2 shadow-lg p-3 mb-3 bg-white ">
                    ...
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <strong>¡Atención!</strong> El merendero es una sala para celebrar reuniones o hacer comidas, etc. Se reserva por día. <br> Antes de dejar la sala, se deberá quedar limpia.
                    ...
                    <h3 class="text-center my-2">Reservar Merendero</h3>
                    <div class="col-sm-12 my-2">
                        <div class="row my-3">
                            <div class="col-sm-3 ">
                                <a class="btn btn-info btn-lg my-3 disabled" href="merendero.php" role="button">Merendero</a>  
                                <img src="../imgs/merendero.jpg" width="90%"  />
                            </div>
                            <div class="col-sm-9">    
                                <form action="../php/agregarReserva.php" method="post">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nombre" name="nombre" value="" required placeholder="Escribe tu nombre" />
                                        </div>
                                    </div> <!--pedir nombre-->
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group my-2">
                                            ...
                                            <input type="number" class="form-control" id="telefono" name="telefono" required pattern="^[9|8|7|6]\d{8}$" value="" placeholder="Escribe tu teléfono" />
                                        </div>
                                    </div> <!--pedir telefono-->
                                    ...
                                    <input type="hidden" name="tipo" value="<?php echo "merendero"; ?>">
